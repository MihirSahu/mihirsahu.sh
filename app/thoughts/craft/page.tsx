...
const paragraphs = [
  ...
  "Craft is the marriage between the depth of thought and the execution of a product. It encompasses design, aesthetics, feel, and functionality. Parts of it can be seen as optional during new waves of innovation. During the software boom in the 1990s, it was difficult enough to get software working, and given the choice between developing new features and refinement, teams often chose the former. The teams that were capable enough of producing a well-crafted product — both in terms of functionality and feel — built the companies we know today. Google, for example, paired its PageRank algorithm with a minimal interface — just a search bar and two buttons. It radiated purpose. Craft is not just the visual aspect of a product — it's the functionality and feel. It's a thread that must be woven into all aspects of the user experience.",
